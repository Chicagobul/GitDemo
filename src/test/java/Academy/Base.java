...
public class Base
{
    ...
    public void getScreenshot(String result) throws IOException
    {
        ...
        // If we have multiple errors in our code so we can't store those screenshots with same name hence we have
        // concatenated the name of the failed test with screenshot.png

        // To run in headless mode use this:
        // ChromeOptions options = new ChromeOptions options();
        // options.addArguments("headless");
        // driver = new ChromeDriver(options);
        // in headless mode the browser doesn't opens
    }
}
